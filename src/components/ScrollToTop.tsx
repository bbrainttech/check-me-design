...
export default () => {
  ...
  return (
    <Button
      ...
      className={cn(
        "fixed right-0 size-8 pointer-events-none make-blur z-50 border hover:bg-background shadow-lg hover:shadow-sm bottom-0 opacity-0 bg-background rounded-full transition-all duration-300 scale-0",
